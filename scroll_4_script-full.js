...
compute(pass){throw new Error("Method 'compute(pass)' must be implemented.");}};class Standard2DVertexObject extends SceneObject{constructor(device,canvasFormat,cameraPose,vertices,shaderFile,topology){super(device,canvasFormat,shaderFile);this._cameraPose=cameraPose;this._vertices=vertices;this._topology=topology;}
