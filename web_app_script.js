import Renderer from '/lib/Viz/2DRenderer.js'
 ...
 async function init() {
   ...
   await renderer.appendSceneObject(new Square2(renderer._device, renderer._canvasFormat, 0, 0, 2.5, 0.2));
   await renderer.appendSceneObject(new Square2(renderer._device, renderer._canvasFormat, 0.3, 0.3, 0.2, 1.5));
