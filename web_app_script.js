import Renderer from '/lib/Viz/2DRenderer.js'
 ...
 async function init() {
   ...
   // Append objects
   await renderer.appendSceneObject(new Triangle1(renderer._device, renderer._canvasFormat, -0.2, 0.2, 0.5, 1.5));
   await renderer.appendSceneObject(new Triangle2(renderer._device, renderer._canvasFormat, 0, 0, 1, 1.5));
